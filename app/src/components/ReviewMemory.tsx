...
const SEED_RULE_DRAFT =
  "Inside Hormuz Watch Box 01, when real OSINT sources produce a dark-gap custody case with corroboration, request SAR/RF imagery before any Escalate option is offered.";
