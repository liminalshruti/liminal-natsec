...
const PHRASE_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\bcarries cached China-routing context\b/g, "carries China-routing context"],
  [/\bcached OSINT\b/g, "OSINT"],
  ...
  [/\bcached-live-api\b/g, "live-api"],
  [/\s+cached$/g, " collected"],
  ...
  [/\bfixture fallback articles\b/g, "unverified local articles"],
  [/\bfixture fallback samples\b/g, "local samples"],
