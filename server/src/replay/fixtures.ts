...
export const fixtureObjects: FixtureObjectWrite[] = [
  {
    ...
    props: {
      ...
      polygon: "POLYGON((56.00 26.35, 57.10 26.35, 57.10 26.85, 56.00 26.85, 56.00 26.35))",
  ...
  },
  {
    ...
    props: {
      ...
      predicted_ellipse: "POLYGON((56.28 25.79,57.99 25.79,57.99 27.33,56.28 27.33,56.28 25.79))",
      updated_at: FIXTURE_INGESTED_AT
    }
  },
  {
